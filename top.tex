...
\end{df}
\begin{ex*}
 \fixme [from GnuLinux: Sorry, dass ich das noch mal reinbringe, aber das kann so immer noch nicht sein, was soll ``$k\to n_k$ monoton`` bedeuten. die Indizes konvergieren gegeneinander ? und der eine Indize hängt noch vom anderen zusätzlich ab ? Wenn man das jedoch rausstreichen würde wäre es Bolzano-Weierstraß und damit wieder in Ordnung. In der Version davor hatte ich jedoch gar nicht verstanden, was der erste Satz aussagen sollte.  Leider habe ich das auch nicht in meinem Aufschrieb weswegen ich nicht wußte worauf du hinaus wolltest. Wenn das so passt einfach fixme wieder entfernen]
