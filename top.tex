...
\end{note*}
\fixme[fig15]\\
\fixme[from GnuLinux: Das Beispiel waren ursprünglich vor Satz 1.3.2. Liegen hier didaktische Überlegungen bei der Umstellung zu Grunde ?????] \\
\fixme[from mathematiker: Vermutlich ja... Wenn ich mich richtig erinnere, habe ich das Ding hier verschoben, weil es darum ging, dass du nun, bei der Quotiententopologie, nicht notwendigerweise hausdorffräume hast, der hat auch irgendwie erwähnt, dass es vielleicht geschickter gewesen wäre, die hierhin zu bringen]
