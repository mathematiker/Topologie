...
\begin{lem}[Kreuzhauben-Normierung]
 Ein gekürztes Flächen-Wort mit Eckenzahl $1$ und $k$ Kreuzhauben ist äquivalent zu $c_1c_1c_2c_2\dotsb c_kc_k\dotsb $, wobei alle sonstigen Kanten genau einmal mit Exponent $+1$ und einmal mit $-1$ auftreten.
\end{lem}
\begin{proof}
.
 \begin{figure}[H]
...
\end{lem}
\begin{proof}
 Falls außer einer Kreuzhaube noch mindestens ein Henkel vorkommt, ist das Wort äquivalent zu $ccaba^{-1}b^{-1}\dotsb $ Wir formulieren:
\begin{figure}[H]
 \centering
\fixme[fig150]
\caption{}
...
\begin{note*}[Endergebnis]
 ...
 \begin{enumerate}[(1)]
  ...
  \item $a_1b_1a_1^{-1} b_1^{-1} a_2 b_2a_2^{-1} b_2^{-1}\dotsb a_gb_g a_g^{-1} b_g^{-1}$ der Realisierung nennen wir auch $F_g, g\ge 1$
...
\[
 \pi_1(X;x_0)=\langle a_1,..,a_r \, \vline \, w(a_1,\dotsc  ,a_r)=1\rangle
\]
