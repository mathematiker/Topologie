...
\]
als Gruppenstruktur. Die Faktoren $G_i$ sind auf kanonische Weise durch die injektive $G_i\to G_1\times \dotsb \times G_k, g_i \mapsto (1,\dotsc, 1, g_i, 1,\dotsc, 1)$ eingebettet (als $\{1\}\times \dotsb \times\{1\} \times G_i \times\{1\} \dotsb \times \{1\})$) und kommutieren miteinander, sind insbesondere Normalteiler.

 Eine ganz andere Konstruktion ist das \emph{freie Produkt} von Gruppen. Seien $G_1,\dotsc, G_k$ disjunkte Gruppen. Ein \emph{Wort} der \emph{Länge} $l\in \N_0$ ist eine Abbildung $\{1,\dotsc, l\} \to G_1\cup \dotsb \cup G_k$, also eine endliche Folge von Elementen $x_1x_2 \dotsc x_l$ mit $x_i\in G_1\cup \dotsb \cup G_k$ das \emph{leere Wort} bezeichnen wir mit $1$.
