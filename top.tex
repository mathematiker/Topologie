...
\begin{st}
 Sei $B$ wegzusammenhängend und lokal wegzusammenhängend. Sei $p:E\to B$ eine Überlagerung mit wegzusammenhängendem Totalraum. Es sei $H(p;e_0)=\pi_1(p)(\pi_1(E;e_0))$ und sei $N(p;e_0)$ der Normalisator von $H(p;e_0)$ in $\pi_1(B;b_0) $, wobei $b_0=p(e_0)$. 
